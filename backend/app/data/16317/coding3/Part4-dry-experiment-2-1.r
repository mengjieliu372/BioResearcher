...
# Install it if not already installed using install.packages("BiocManager") and BiocManager::install("clusterProfiler")
library(clusterProfiler)

# Step 1: Read the DEGs input data containing gene identifiers and adjusted P-values
# Replace '/actual/path/to/differentially_expressed_genes.csv' with the correct path
